function [mapCluster, centroid] = plot_cars_no_ground(groundfilename, notgroundfilename,pose)
...
%         area_limit = obj_width * obj_length < 2.25;
    ...
    figure(100)
    idx = 1;
    centroid = zeros(mapCluster.Count,3);
    for current_label = keys(mapCluster)
        mapCluster(current_label{1});
        current_obj= mapCluster(current_label{1});
